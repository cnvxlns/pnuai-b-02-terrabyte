...
class Settings:
    ...
    def from_env(cls, env: Mapping[str, str] | None = None) -> "Settings":
        ...
        # it here rather than reusing the frozenset below keeps the two
        # ``_node_keyed_map`` calls reading against the *validated* ids.
        known_node_ids = frozenset(expected_node_ids)
